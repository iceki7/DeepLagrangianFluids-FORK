...
y_train[...,-2]=np.sum(y_train[...,0:4],axis=1)+y_train[...,4]+y_train[...,5]
y_train[...,-1]=                                y_train[...,4]+y_train[...,5]
# y_train[...,-1]=                                np.zeros_like(y_train[...,-2])

# print('range')
# print(np.mean(y_train[...,-2]))3.0136
# print(np.mean(y_train[...,-1]))1.0007
# assert(False)
...
for i in range(0,6):
    ...
    maxe=np.sum(x_test[...,:4],axis=1)+x_test[...,4]+x_test[...,5]
    mine=                       +      x_test[...,4]+x_test[...,5]
    # maxe=1
    # mine=0
